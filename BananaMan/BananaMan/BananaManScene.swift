...
class BananaManScene: SKScene, SKPhysicsContactDelegate {
    ...
    let bananamanDarkColor = SKColor(red: 83/255.0, green: 83/255.0, blue: 83/255.0, alpha: 1)
    ...
    func subtitleLabel() -> SKLabelNode {
        ...
        subtitleNode.fontColor = bananamanDarkColor
    ...
    func scoreLabel() -> SKLabelNode {
        ...
        scoreNode.fontColor = bananamanDarkColor
    ...
    func jump() {
        ...
        if let pb = bananamanSpriteNode.physicsBody {
            pb.applyImpulse(CGVector(dx:0, dy:8.8), at: bananamanSpriteNode.position)
        }
    }
